...
@section('title')
  <title>Add Teacher | BdCollage</title>
@endsection
        ...
        <div class="row">
          <div class="col-lg-12 col-md-12 col-sm-12">
            <div class="card">
              ...
              <!-- /.card-header -->
                 <form method="post" action="{{ route('employee.registration.store') }}" id="quickForm" novalidate="novalidate" enctype="multipart/form-data"> 
                  @csrf
                    <div class="card-body">
                      ...
                      <div class="row">
                        ...
                        <div class="col-md-4">
                          <div class="form-group">
                            ...
                            <input type="date" name="join_date" class="form-control" id="join_date" placeholder="Enter Joining Date">
                          </div>
                        </div>
                        <div class="col-md-4">
                          <div class="form-group">
