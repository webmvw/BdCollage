...
@section('title')
  <title>Edit Employee Attendance | BdCollage</title>
@endsection
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Edit Employee Attendance</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
          ...
          <div class="col-lg-12 col-md-12 col-sm-12">
            <div class="card">
              <div class="card-header d-flex justify-content-between align-items-center">
                <h3 class="card-title">Edit Employee Attendance - {{ date('F j, Y', strtotime($getAttendance[0]->date)) }}</h3>
                      ...
                      <div class="row">
                        <div class="col-md-6">
                          <div class="form-group">
                            ...
                            <input type="date" value="{{ $getAttendance[0]->date }}" name="date" id="date" class="form-control">
                          </div>
                        </div>
                        ...
                        <tbody>
                          ...
                          <tr id="div{{ $value->id }}">
                            ...
                            <td class="text-center">
                              <input type="radio" name="attend_status{{$key}}" value="Present" id="present{{$key}}" {{ ($value->attend_status == 'Present')? 'checked': '' }}>
