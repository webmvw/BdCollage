...
@section('title')
  <title>Add Fee Amount | BdCollage</title>
@endsection
        ...
        <div class="row">
          <div class="col-lg-12 col-md-12 col-sm-12">
            <div class="card">
              ...
              <!-- /.card-header -->
                 <form method="post" action="{{ route('feeAmount.store') }}" id="quickForm" novalidate="novalidate"> 
                  @csrf
                    <div class="card-body">
                      ...
                      <div class="row">
                        <div class="col-lg-6 col-md-6 col-sm-12">
                          <div class="form-group">
                            ...
                            <select id="feeCategory" name="feeCategory" class="form-control">
