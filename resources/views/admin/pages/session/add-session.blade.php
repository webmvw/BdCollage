...
@section('title')
  <title>Add Session | BdCollage</title>
@endsection
        ...
        <div class="row">
          <div class="col-lg-12 col-md-12 col-sm-12">
            <div class="card">
              ...
              <!-- /.card-header -->
                 <form method="post" action="{{ route('session.store') }}" id="quickForm" novalidate="novalidate"> 
                  @csrf
                    <div class="card-body">
                      ...
                      <div class="row">
                        <div class="col-md-6">
                          <div class="form-group">
                            ...
                            <input type="text" name="name" class="form-control" id="name" placeholder="Example: 2017-2018">
                          </div>
                        </div>
                        <div class="col-md-6">
                        </div>
