...
@section('title')
  <title>Edit Marks Entry | BdCollage</title>
@endsection
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Edit Marks Entry</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">Home</a></li>
              <li class="breadcrumb-item"><a href="{{ route('student.marks.entry.view') }}">Student Marks Entry</a></li>
              <li class="breadcrumb-item active">Edit Marks Entry</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
          ...
          <div class="col-lg-12 col-md-12 col-sm-12">
            <div class="card">
              <div class="card-header d-flex justify-content-between align-items-center">
                <h3 class="card-title">Edit Marks Entry</h3>
              </div>
              
              <!-- /.card-header -->
              <form action="{{ route('student.marks.entry.update') }}" method="post">
                @csrf
                <div class="card-body">
                  <div class="row">
                    <div class="col-md-3">
                ...
                <div class="card-footer">
                  <button id="mark-entry-btn" class="btn btn-success d-none">Update</button>
                </div>
              </form>
            </div>
          </div>
      ...
      success:function(data){
        ...
        $.each(data, function(key,v){
          html+='<tr>'+
                  ...
                  '<td><input type="number" class="form-control" placeholder="Enter Marks" name="mark[]" value="'+v.marks+'" required></td>'
                  '</tr>';
        });
