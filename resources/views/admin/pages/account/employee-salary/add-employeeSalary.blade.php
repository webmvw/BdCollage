...
@section('title')
  <title>Add Employee Salary | BdCollage</title>
@endsection
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Add Employee Salary</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">Home</a></li>
              <li class="breadcrumb-item"><a href="{{ route('account.employee.salary.view') }}">View Employee Salary</a></li>
          ...
          <div class="col-lg-12 col-md-12 col-sm-12">
            <div class="card">
              <div class="card-header d-flex justify-content-between align-items-center">
                ...
                <a href="{{ route('account.employee.salary.view') }}" class="btn btn-success btn-sm"><i class="fa fa-list"></i> Employee Salary List</a>
              </div>
              ...
              <!-- /.card-header -->
                ...
                <div class="card-body">
                  ...
                  <script id="document-template" type="text/x-handlebars-template">
                    ...
                    <form action="{{ route('account.employee.salary.store') }}" method="post">
                      @csrf
