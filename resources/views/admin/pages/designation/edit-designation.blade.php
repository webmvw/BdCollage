...
@section('title')
  <title>Edit Designation | BdCollage</title>
@endsection
          ...
          <div class="col-lg-12 col-md-12 col-sm-12">
            <div class="card">
              <div class="card-header d-flex justify-content-between align-items-center">
                ...
                <a href="{{ route('semester.view') }}" class="btn btn-success btn-sm"><i class="fa fa-list"></i> Designation List</a>
              </div>

              <!-- /.card-header -->
                 <form method="post" action="{{ route('designation.update', $designation->id) }}" id="quickForm" novalidate="novalidate"> 
                  @csrf
                    <div class="card-body">
